        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedExtensions = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SettingNameRegex = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConfigSectionTypesId = table.Column<int>(type: "INTEGER", nullable: false),
                    FileExtensionsId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SettingDefinitionsId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AllowedValuesId = table.Column<int>(type: "INTEGER", nullable: false),
                    ValueSettingDefinitionsId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", nullable: true),
                    FilePattern = table.Column<string>(type: "TEXT", nullable: true),
                    ConfigSectionTypeId = table.Column<int>(type: "INTEGER", nullable: true),
                    EditorConfigFileId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<string>(type: "TEXT", nullable: true),
                    Name = table.Column<string>(type: "TEXT", nullable: true),
                    ConfigSectionId = table.Column<int>(type: "INTEGER", nullable: true),
                    SettingDefinitionId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConfigSectionsId = table.Column<int>(type: "INTEGER", nullable: false),
                    FileExtensionsId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<string>(type: "TEXT", nullable: false),
                    ConfigSectionId = table.Column<int>(type: "INTEGER", nullable: true),
                    ConfigEntryId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
